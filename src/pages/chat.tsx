...
const ChatWidget = ({ group, membership }: ChatWidgetProps) => {
...
export default function ChatPage() {
	...
	return (
		<MainLayout>
			<div className="w-full text-3xl font-bold">Your Roommate Group Chat</div>
			<ChatWidget group={membership.group} membership={membership} />
		</MainLayout>
	);
}
