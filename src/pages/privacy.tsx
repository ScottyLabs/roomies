	...
	<>
		<article className="prose">
			...
			<p>
				...
				in our Terms and Conditions, accessible from https://roomies.live
			</p>
			<h2>Definitions</h2>
			<ul>
				<li>
					<h3>Service</h3>
					<p>Service is the https://roomies.com website operated by Roomies</p>
				</li>
				<li>
					<h3>Personal Data</h3>
					<p>
			...
			<p>
				...
				google, and not us. We may use email addresses in the future, only to
				send registered users emails about our service.
			</p>
			...
			<ul>
				<li>
					...
					<p>
						We use Session Cookies to keep you logged in to Discord on our site.
						We also use Google Analytics, which uses cookies for general
			...
			<p>
				Roomies will retain your Personal Data only for as long as is necessary
			...
			<h2>Contact Us</h2>
			<p>
				If you have any questions about our Privacy Policy, please contact us us{" "}
