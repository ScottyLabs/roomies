		...
		<>
			<article className="prose">
				...
				<p>
					...
					Service&quot;) carefully before using the https://roomies.live website
					(the &quot;Service&quot;) operated by Roomies (&quot;us&quot;,
					&quot;we&quot;, or &quot;our&quot;).
				</p>
				<p>
				...
				<p>
					...
					that are not owned or controlled by Roomies.
				</p>
				<p>
					Roomies has no control over, and assumes no responsibility for the
				...
				<p>
					You acknowledge and agree that Roomies shall not be responsible or
				...
				<p>
					You agree to defend, indemnify and hold harmless Roomies and its
				...
				<p>
					Roomies its subsidiaries, affiliates, and its licensors do not warrant
				...
				<p>
					...
					us <Link href="mailto:adrastopoulos@gmail.com">here</Link>.
				</p>
			</article>
		</>
	);
