	...
	return (
		<>
			<article className="prose">
				...
				<p>
					Roomies (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates
					the https://roomies.live website (hereinafter referred to as the
					&quot;Service&quot;).
				</p>
				<p>
				...
				<p>
					...
					as in our Terms and Conditions, accessible from https://roomies.live
				</p>
				<h2>Definitions</h2>
				<ul>
					<li>
						<h3>Service</h3>
						<p>
							Service is the https://roomies.com website operated by Roomies
						</p>
					</li>
					<li>
						<h3>Personal Data</h3>
				...
				<p>
					...
					all stored by google, and not us. We may use email addresses in the
					future, only to send registered users emails about our service.
				</p>
				...
				<ul>
					<li>
						...
						<p>
							We use Session Cookies to keep you logged in to Discord on our
							site. We also use Google Analytics, which uses cookies for general
							statistical data to help us learn and grow about how to make a
							better user experience.
						</p>
					</li>
				</ul>
				<h2>Use of Data</h2>
				<p>Roomies uses the collected data for various purposes:</p>
				<ul>
				...
				<p>
					If you are from the European Economic Area (EEA), Roomies legal basis
				...
				<p>Roomies may process your Personal Data because:</p>
				<ul>
				...
				<p>
					Roomies will retain your Personal Data only for as long as is
				...
				<p>
					Roomies will take all the steps reasonably necessary to ensure that
				...
				<p>
					Roomies may disclose your Personal Data in the good faith belief that
					such action is necessary to:
				</p>
				<ul>
					<li>To comply with a legal obligation</li>
					<li>To protect and defend the rights or property of Roomies</li>
					<li>
